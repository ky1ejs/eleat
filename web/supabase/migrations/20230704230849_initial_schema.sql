...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."item" FOR INSERT TO "authenticated" WITH CHECK (true);
CREATE POLICY "Enable select for authenticated users only" ON "public"."item" FOR SELECT TO "authenticated" USING (true);
