...
export function saveUser(user: User) {
  ...
  if (!user.weight_in_grams || user.weight_in_grams <= 0) {
    delete user.weight_in_grams;
  }
  if (!user.dob) {
    delete user.dob;
  }
  ...
  if (
    !user.macros_target ||
    user.macros_target.carb_percentage < 0 ||
    user.macros_target.carb_percentage > 1 ||
    user.macros_target.protein_percentage < 0 ||
    user.macros_target.protein_percentage > 1 ||
    user.macros_target.fat_percentage < 0 ||
    user.macros_target.fat_percentage > 1 ||
    user.macros_target.fat_percentage +
      user.macros_target.protein_percentage +
      user.macros_target.carb_percentage !=
      1
  ) {
